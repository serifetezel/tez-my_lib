// ignore_for_file: unnecessary_this, prefer_const_constructors, avoid_unnecessary_containers, unused_local_variable, sized_box_for_whitespace, prefer_const_declarations, avoid_print, unused_element, unnecessary_new
import 'dart:convert';
...
class DetailBookPage extends StatefulWidget {
  ...
  final int ?index;
  const DetailBookPage({ Key? key, this.bookInfo, this.index }) : super(key: key);
              ...
              children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: NetworkImage(widget.bookInfo!.Image_link ?? "https://i.dr.com.tr/cache/500x400-0/originals/0000000061603-1.jpg") ,
                              fit: BoxFit.fill
                            )
                          ),
                        ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child:SingleChildScrollView(
                                child: TextWidget(text: this.widget.bookInfo!.Name, fontSize: 26))),
                            SizedBox(height: 10),
                            TextWidget(text: this.widget.bookInfo!.Author,fontSize: 20,color: Color(0xFF7b8ea3)),
                            Divider(color: Colors.grey),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Icon(Icons.rate_review, color: Color(0xFF7b8ea3)),
                                TextWidget(text: this.widget.bookInfo!.Rating.toString(), fontSize: 16, color: Color(0xFF7b8ea3)),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 5),
                                TextWidget(text: this.widget.bookInfo!.Genres.toString(), fontSize: 16, color: Color(0xFF7b8ea3)),
                              ],
                            )
                          ],
                        ),
                                                  ...
                                                  children: [
                                                    ElevatedButton(
                                                      ...
                                                      onPressed: ()async{
                                                        ...
                                                        ? debugPrint('Hata')
                                                        : Navigator.push(context, MaterialPageRoute(builder: (context) => SameRatingList(searchTerm: double.parse(notController.text), title: this.widget.bookInfo!.Name.toString())));
                                                      debugPrint('başarılı');
                                                      },
                                                    )
                                                  ],
                          ...
                          children: <Widget>[
                            ...
                            onTap: (isLiked) async {
                              if(isLiked){
                                ...
                                this.isLiked = !isLiked;
                                Map<String, dynamic> savedBook = {
                                  'Author': widget.bookInfo!.Author.toString(),
                                  'Genres': widget.bookInfo!.Genres.toString(),
                                  'Name': widget.bookInfo!.Name.toString(),
                                  'Description': widget.bookInfo!.Description.toString(),
                                  'Image_link': widget.bookInfo!.Image_link.toString(),
                                  'Rating': widget.bookInfo!.Rating,
                                  'kullaniciid': auth.currentUser!.uid 
                                };
                                await FirebaseFirestore.instance
                                  .collection("saved")
                                  .doc(widget.bookInfo!.Name.toString())
                                  .set(savedBook);
                ...
                Container(
                  ...
                  child: SingleChildScrollView(child: Padding(
                    ...
                    child:TextWidget(text: this.widget.bookInfo!.Description, fontSize: 16, color: Colors.grey),
                  )),
                ),
                SizedBox(height: 10,),
                Divider(color: Color(0xFF7b8ea3)),
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        TextButton(child:Text( "Benzer Yazar Kitapları", style: TextStyle(fontSize: 20, color: Colors.black, fontFamily: "Avenir",fontWeight: FontWeight.w900,)), onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => RecommendAuthorList(searchTerm:  this.widget.bookInfo!.Name.toString())));},),
                        Expanded(child: Container()),
                        IconButton(icon: Icon(Icons.arrow_forward_ios), onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => RecommendAuthorList(searchTerm:  this.widget.bookInfo!.Name.toString() )));}),
                      ],
                    ),
                  ),
                ),
