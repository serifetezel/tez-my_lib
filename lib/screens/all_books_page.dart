...
class AllBookPage extends StatefulWidget {
  const AllBookPage({ Key? key }) : super(key: key);
...
class _AllBookPageState extends State<AllBookPage> {
  ...
  void getAllBooksFromApi()async{
    var response = await http.get(Uri.parse('http://172.20.10.9:5000/books'));
      setState(() {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text('BÜTÜN KİTAPLAR', style: TextStyle(fontSize: 26,color: Color(0xFF363f93), fontStyle: FontStyle.italic, fontWeight: FontWeight.bold)),
                  ),
                ),
                IconButton(
                  padding: EdgeInsets.zero,
